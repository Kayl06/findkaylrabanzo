...
export default function ContactForm() {
  ...
  const inputClass =
    "w-full __input-glass px-4 py-3 disabled:opacity-60";
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-[520px] mx-auto text-left">
      ...
      <button
        type="submit"
        disabled={status === "sending"}
        className="btn-primary-v3 w-full sm:w-auto disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:transform-none disabled:hover:shadow-none"
      >
